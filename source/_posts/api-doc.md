...
+ cppreference API参考
  + [在线浏览（英文）](http://en.cppreference.com/w/c)
  + [离线下载（英文）](http://kapeli.com/docset_links)

## Chrome ##

+ 扩展开发文档
  + [在线浏览（**中文**）](http://open.chrome.360.cn/extension_dev/overview.html)
  + 离线下载（**中文**）
...
+ MDN API参考
  + [在线浏览（英文）](https://developer.mozilla.org/en-US/docs/Web/CSS/Reference)
  + [离线下载（英文）](http://kapeli.com/docset_links)
...
+ MSDN 官方文档
  + [在线浏览（**中文**）](http://shouce.jb51.net/net/index.html)
+ MSDN API参考
  + [在线浏览（**中文**）](http://msdn.microsoft.com/zh-cn/library/gg145045.aspx)

## Django ##

+ 官方文档
  + [在线浏览（**中文**）](http://django-chinese-docs.readthedocs.org/en/latest/)
+ django book
  + [在线浏览（**中文**）](http://docs.30c.org/djangobook2/)
...
+ MDN API参考
  + [在线浏览（英文）](https://developer.mozilla.org/en-US/docs/Web/HTML/Element)
  + [离线下载（英文）](http://kapeli.com/docset_links)
  
## Java ##

+ se6 API参考
  + [在线浏览（**中文**）](http://dlc.sun.com.edgesuite.net/jdk/jdk-api-localizations/jdk-api-zh-cn/publish/1.6.0/html/zh_CN/api/index.html)
  + [离线下载（**中文**）](http://www.pc6.com/softview/SoftView_74643.html)
+ se7 API参考
...
+ MDN API参考
  + [在线浏览（英文）](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference)
  + [离线下载（英文）](http://kapeli.com/docset_links)

## jquery ##

+ 官方 API参考
  + [在线浏览（**中文**）](http://docs.30c.org/jquery16/)

## jquery ui #

+ 官方文档
  + [在线浏览（**中文**）](http://www.css88.com/jquery-ui-api/)

## Laravel ##

+ 官方文档
  + [在线浏览（**中文**）](http://v4.golaravel.com/docs/4.2)

## Linux ##

+ Linux C API参考
  + [在线浏览（**中文**）](http://net.pku.edu.cn/~yhf/linux_c/)
  + 离线下载（**中文**）
...
+ Linux 常用命令参考
  + [在线浏览（**中文**）](http://www.jb51.net/linux/)
  + 离线下载（**中文**）
...
+ 官方文档
  + [在线浏览（**中文**）](http://docs.mongoing.com/manual-zh/)

## MySQL ##

+ 官方文档
  + [在线浏览（**中文**）](http://doc.mysql.cn/mysql5/refman-5.1-zh.html-chapter/)
  
## Nginx ##

+ 官方文档
  + [在线浏览（**中文**）](http://www.nginx.cn/doc/)

## Node.js ##

+ 官方API参考
  + [在线浏览（**中文**）](http://nodeapi.ucdok.com/#/api/)

## php ##

+ 官方文档
  + [在线浏览（**中文**）](http://php.net/manual/zh/)
  + [离线下载（**中文**）](http://php.net/get/php_manual_zh.chm/from/a/mirror)
...
+ QT3 官方文档
  + [在线浏览（**中文**）](http://www.kuqin.com/qtdocument/)
  + 离线下载（**中文**）
...
+ 官方文档
  + [在线浏览（**中文**）](http://redisdoc.com)
  + [离线下载（**中文**）](https://github.com/huangz1990/redis/tree/master/download)

## Ruby ##

+ 官方文档
  + [在线浏览（**中文**）](http://shouce.jb51.net/ruby/)
  + [离线下载（**中文**）](http://www.cr173.com/soft/65602.html)

## Spring ##

+ 官方文档
  + [离线下载（**中文**）](http://www.cr173.com/soft/66146.html)
+ 官方API参考
...
+ swift 编程语言 中文完整版
  + [在线浏览（**中文**）](http://numbbbbb.gitbooks.io/-the-swift-programming-language-/content/)
  + [离线下载（**中文**）](http://vdisk.weibo.com/s/EhsPPzRRQ5CZ/1402621206)
+ using swift with cocoa and object-c 中文完整版
  + [在线浏览（**中文**）](https://github.com/CocoaChina-editors/Welcome-to-Swift/blob/master/UsingSwiftwithCocoaandObjective-C%E4%B8%AD%E6%96%87%E6%89%8B%E5%86%8C.md)
  + [离线下载（**中文**）](http://vdisk.weibo.com/s/EhsPPzRRQHNd)

## Vbscript ##

+ 官方文档
  + [离线下载（**中文**）](http://www.jb51.net/books/239.html)
